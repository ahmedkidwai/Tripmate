...
import * as actions from '../../src/actions/createHotel';
...
describe('add hotel actions', () => {
  ...
  it('creates CREATE_HOTEL_SUCCESS when fetching hotel has been done', () => {
    mockAxios.onPost(url + '/hotel/add/5e6aeefdb3256d55d6091d82').reply(200, [
      {
        data: 'Hotel added.',
      },
    ]);
  ...
  it('creates CREATE_HOTEL_FAILURE when fetching hotel has failed', () => {
    mockAxios.onPost(url + '/hotel/add/5e6aeefdb3256d55d6091d82').reply(500);
