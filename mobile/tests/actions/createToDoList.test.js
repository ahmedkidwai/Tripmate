...
import * as actions from '../../src/actions/createToDoList';
...
describe('add todolist actions', () => {
  ...
  it('creates CREATE_TODO_LIST_SUCCESS when creating todolist has been done', () => {
    mockAxios
      .onPost(url + '/todolist/add/5e6aeefdb3256d55d6091d82')
  ...
  it('creates CREATE_TODO_LIST_FAILURE when creating todolist has failed', () => {
    mockAxios.onPost(url + '/todolist/add/5e6aeefdb3256d55d6091d82').reply(500);
