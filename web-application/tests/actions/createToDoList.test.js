...
describe('add todolist actions', () => {
  ...
  it('creates CREATE_TODO_LIST_SUCCESS when creating todolist has been done', () => {
    mockAxios.onPost('/todolist/add/5e6aeefdb3256d55d6091d82').reply(200, 'New ToDo List Added!');
    
    return store.dispatch(actions.createToDoList('5e6aeefdb3256d55d6091d82')).then(() => {
