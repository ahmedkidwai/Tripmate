...
describe('async actions', () => {
  ...
  it('creates GET_TICKET_SUCCESS when fetching ticket has been done', () => {
    mockAxios.onGet('/ticket/trip/5e6aeefdb3256d55d6091d82').reply(200, [{name: 'Test Ticket'}]);

    return store.dispatch(actions.fetchTicket('5e6aeefdb3256d55d6091d82')).then(() => {
