...
describe('async actions', () => {
  ...
  it('creates GET_TODO_LIST_SUCCESS when fetching todolist has been done', () => {
    mockAxios.onGet('/todolist/trip/5e6aeefdb3256d55d6091d82').reply(200, [{name: 'Test ToDo List'}]);

    return store.dispatch(actions.fetchToDoList('5e6aeefdb3256d55d6091d82')).then(() => {
