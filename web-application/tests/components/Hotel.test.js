...
describe('Hotels Component', () => {
    ...
    it('is not loading and should render self and sub elements', () => {
        const wrapper = shallow(<Hotels hotel={[
        ...
        expect(wrapper.find('p').at(0).text()).toBe('Test Hotel 1');
        expect(wrapper.find('p').at(1).text()).toBe('Test Hotel 2');
        expect(wrapper.find('p').at(2).text()).toBe('Test Hotel 3');
    });
